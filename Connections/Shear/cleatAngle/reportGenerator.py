...
#Diagram
    ...
    row = [0, '<object type="image/PNG" data="3D_Model.png" width ="300"></object>', '<object type="image/svg+xml" data="cleatTop.svg" width ="400"></object>']
    rstr += t('tr')
    rstr += t('td  align="center" class=" viewtbl"') + space(row[0]) + row[1] + t('/td')
    rstr += t('td  align="center" class=" viewtbl"') + row[2] + t('/td')
    rstr += t('/tr')
     
    row = [0, '<object type="image/svg+xml" data="cleatSide.svg" width ="400"></object>', '<object type="image/svg+xml" data="cleatFront.svg" width ="400"></object>']
    rstr += t('tr')
    rstr += t('td align="center" class=" viewtbl"') + space(row[0]) + row[1] + t('/td')
    rstr += t('td align="center" class=" viewtbl "') + row[2] + t('/td')
    rstr += t('/tr')
