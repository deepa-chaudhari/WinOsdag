...
#     row =[0,"No. of bolts", shear_load + "/" + boltCapacity + " = " + bolts, noOfBolts, " <p align=left style=color:green><b>Pass</b></p>"]
    ...
    if connectivity == "Column web-Beam web":
        ...
        maxWidth = 140 + 2*(gauge+ end)
        strmaxWidth = str(int(140 + 2*(int(gauge+ end))))
...
#Digram
    ...
    row = [0, '<object type="image/PNG" data="3D_Model.png" width ="300"></object>', '<object type="image/svg+xml" data="endTop.svg" width ="400"></object>']
    rstr += t('tr')
